...
var LoginComponent = (function () {
    function LoginComponent(auth, flashMsgs, router) {
        this.auth = auth;
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.auth.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMsgs.show('You are now logged in!', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/dashboard']);
            }
            else {
                _this.flashMsgs.show(data.msg, { cssClass: 'alert-danger', timeout: 5000 });
...
var NavbarComponent = (function () {
    function NavbarComponent(auth, flashMsgs, router) {
        this.auth = auth;
        this.flashMsgs = flashMsgs;
        this.router = router;
    }
    ...
    NavbarComponent.prototype.onLogoutClicked = function () {
        this.auth.logout();
        this.flashMsgs.show('You are logged out', { cssClass: 'alert-success', timeout: 3000 });
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        if (!this.validateService.validateRegister(user)) {
            this.flashMsg.show('All fields are required', { cssClass: 'alert-danger', timeout: 3000 });
            return false;
        }
        // email validation
        if (!this.validateService.validateEmail(user.email)) {
            this.flashMsg.show('Please provide a valid email', { cssClass: 'alert-danger', timeout: 3000 });
            return false;
        }
        //register user
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_map__ = __webpack_require__(184);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_home_home_component__ = __webpack_require__(99);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__services_validate_service__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__services_auth_service__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__guards_auth_guard__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_angular2_flash_messages__ = __webpack_require__(30);
